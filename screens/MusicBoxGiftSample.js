...
const MusicBoxGiftSample = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.musicBoxGiftSample4}>
      <View style={styles.musicBoxGiftSample4Child} />
      ...
      <Image
        style={styles.musicBoxGiftSample4Item}
        contentFit="cover"
      ...
      />
      <Text style={[styles.cruelSummer, styles.cruelSummerLayout]}>
        Cruel Summer
      </Text>
      <Text style={[styles.taylorSwift, styles.textTypo]}>Taylor Swift</Text>
      <Pressable
      ...
      <Text style={[styles.ourFirstKiss, styles.chrisTypo1]}>
        Our first kiss, remember?
      </Text>
      <Text style={[styles.chris, styles.chrisTypo]}>Chris</Text>
      <Text style={[styles.feb14th2023, styles.textTypo]}>Feb. 14th, 2023</Text>
      <Image
      ...
      <View style={[styles.musicBoxGiftSample4Inner, styles.lyricsTransform]} />
      ...
      <Text style={[styles.howCouldI, styles.textTypo]}>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("MusicBoxGiftSample1")}
      >
        <Image
          style={[styles.icon, styles.iconLayout2]}
          contentFit="cover"
      ...
      />
      <Image
        style={styles.songImageIcon}
        contentFit="cover"
        source={require("../assets/song-image2.png")}
      />
      <Image
        style={[styles.musicBoxGiftSample4Child1, styles.musicChildPosition]}
        contentFit="cover"
        source={require("../assets/vector-2.png")}
      />
      <Image
        style={[styles.musicBoxGiftSample4Child2, styles.musicChildPosition]}
        contentFit="cover"
...
const styles = StyleSheet.create({
  ...
  musicBoxGiftSample4Child1: {
    width: 332,
  },
  musicBoxGiftSample4Child2: {
    width: 68,
  },
  ellipseIcon: {
    top: 556,
...
export default MusicBoxGiftSample;
