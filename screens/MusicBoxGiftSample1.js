...
const MusicBoxGiftSample1 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.musicBoxGiftSample5}>
      <View style={styles.musicBoxGiftSample5Child} />
      <View style={styles.messageTextBox} />
      <Image
        style={[styles.sarcasticIcon, styles.iconLayout2]}
        contentFit="cover"
        source={require("../assets/08sarcastic.png")}
      />
      <View style={[styles.messageTextBox1, styles.messageLayout]} />
      <View style={[styles.messageTextBox2, styles.messageLayout]} />
      <Image
        style={styles.musicBoxGiftSample5Item}
        contentFit="cover"
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/-13love.png")}
      />
      <Image
        style={[styles.smileIcon, styles.iconLayout1]}
        contentFit="cover"
        source={require("../assets/-01smile.png")}
      />
      <Image
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/-15kiss-love.png")}
      />
      <Image
        style={[styles.wowIcon, styles.iconPosition]}
        contentFit="cover"
        source={require("../assets/-11wow.png")}
      />
      <Image
        style={[styles.pukeIcon, styles.iconLayout1]}
        contentFit="cover"
        source={require("../assets/-26puke.png")}
      />
      <Text style={[styles.roses, styles.rosesLayout]}>Roses</Text>
      <Text style={[styles.saintJhn, styles.textTypo]}>SAINt JHN</Text>
      <Pressable
      ...
      <Text style={[styles.thinkingAboutOur, styles.textTypo]}>
        Thinking about our night out at the lake. Miss you lots.
      </Text>
      <Text style={[styles.chris, styles.chrisTypo]}>Chris</Text>
      <Text style={[styles.feb12th2022, styles.textTypo]}>Feb. 12th, 2022</Text>
      <Image
      ...
      <View style={[styles.musicBoxGiftSample5Inner, styles.lyricsTransform]} />
      ...
      <Text style={[styles.comment2, styles.textTypo]}>Comment...</Text>
      <Image
        style={[styles.microphoneIcon, styles.iconLayout]}
        contentFit="cover"
        source={require("../assets/microphone-icon1.png")}
      />
      <View style={[styles.rectangleParent, styles.groupChildLayout]}>
        <View style={[styles.groupChild, styles.groupChildLayout]} />
        <Text style={[styles.giftBackToContainer, styles.chrisTypo]}>
          <Text style={styles.textTypo}>{`Gift Back to `}</Text>
          <Text style={styles.rosesTypo}>Chris</Text>
        </Text>
        <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("MusicBoxGiftSample")}
      >
        <Image
          style={[styles.icon, styles.iconLayout2]}
          contentFit="cover"
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("MusicBoxGiftSample2")}
      >
        <Image
          style={[styles.icon, styles.iconLayout2]}
          contentFit="cover"
      ...
      />
      <Image
        style={styles.song51Icon}
        contentFit="cover"
        source={require("../assets/song-5-11.png")}
      />
      <Image
        style={[styles.musicBoxGiftSample5Child1, styles.musicChildPosition]}
        contentFit="cover"
        source={require("../assets/vector-2.png")}
      />
      <Image
        style={[styles.musicBoxGiftSample5Child2, styles.musicChildPosition]}
        contentFit="cover"
...
const styles = StyleSheet.create({
  ...
  musicBoxGiftSample5Child1: {
    width: 332,
  },
  musicBoxGiftSample5Child2: {
    width: 68,
  },
  ellipseIcon: {
    top: 556,
...
export default MusicBoxGiftSample1;
