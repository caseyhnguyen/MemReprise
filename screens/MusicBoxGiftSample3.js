...
const MusicBoxGiftSample3 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.musicBoxGiftSample1}>
      <View style={styles.musicBoxGiftSample1Child} />
      <View style={styles.messageTextBox} />
      <Image
        style={[styles.sarcasticIcon, styles.iconLayout2]}
        contentFit="cover"
        source={require("../assets/08sarcastic1.png")}
      />
      <View style={[styles.messageTextBox1, styles.messageLayout]} />
      <View style={[styles.messageTextBox2, styles.messageLayout]} />
      <Image
        style={styles.musicBoxGiftSample1Item}
        contentFit="cover"
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/-13love1.png")}
      />
      <Image
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/-15kiss-love1.png")}
      />
      <Image
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/-26puke1.png")}
      />
      ...
      <View style={[styles.musicBoxGiftSample1Inner, styles.lyricsTransform]} />
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/microphone-icon3.png")}
      />
      <View style={[styles.rectangleParent, styles.groupChildLayout]}>
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/layer-114.png")}
        />
      </View>
      <Pressable
      ...
      />
      <Image
        style={[styles.musicBoxGiftSample1Child1, styles.musicChildPosition]}
        contentFit="cover"
        source={require("../assets/vector-2.png")}
      />
      <Image
        style={[styles.musicBoxGiftSample1Child2, styles.musicChildPosition]}
        contentFit="cover"
...
const styles = StyleSheet.create({
  ...
  musicBoxGiftSample1Child1: {
    width: 332,
  },
  musicBoxGiftSample1Child2: {
    width: 68,
  },
  ellipseIcon: {
    top: 556,
...
export default MusicBoxGiftSample3;
