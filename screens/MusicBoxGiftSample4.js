...
const MusicBoxGiftSample4 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.musicBoxGiftSample2}>
      <View style={styles.musicBoxGiftSample2Child} />
      ...
      <Image
        style={styles.musicBoxGiftSample2Item}
        contentFit="cover"
      ...
      <View style={[styles.musicBoxGiftSample2Inner, styles.lyricsTransform]} />
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/microphone-icon4.png")}
      />
      ...
      />
      <Image
        style={[styles.musicBoxGiftSample2Child1, styles.musicChildPosition]}
        contentFit="cover"
        source={require("../assets/vector-2.png")}
      />
      <Image
        style={[styles.musicBoxGiftSample2Child2, styles.musicChildPosition]}
        contentFit="cover"
...
const styles = StyleSheet.create({
  ...
  musicBoxGiftSample2Child1: {
    width: 332,
  },
  musicBoxGiftSample2Child2: {
    width: 68,
  },
  ellipseIcon: {
    top: 556,
...
export default MusicBoxGiftSample4;
