...
const MusicBoxGiftSample2 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.musicBoxGiftSample6}>
      <View style={styles.musicBoxGiftSample6Child} />
      ...
      <Image
        style={styles.musicBoxGiftSample6Item}
        contentFit="cover"
      ...
      <View style={[styles.musicBoxGiftSample6Inner, styles.lyricsTransform]} />
      ...
      />
      <Image
        style={[styles.musicBoxGiftSample6Child1, styles.musicChildPosition]}
        contentFit="cover"
        source={require("../assets/vector-2.png")}
      />
      <Image
        style={[styles.musicBoxGiftSample6Child2, styles.musicChildPosition]}
        contentFit="cover"
...
const styles = StyleSheet.create({
  ...
  musicBoxGiftSample6Child1: {
    width: 332,
  },
  musicBoxGiftSample6Child2: {
    width: 68,
  },
  ellipseIcon: {
    top: 556,
...
export default MusicBoxGiftSample2;
